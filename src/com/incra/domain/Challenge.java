...
@Entity
@Table(name = "challenge", uniqueConstraints = @UniqueConstraint(columnNames = { "name" }))
public class Challenge extends AbstractDomain implements Serializable {
